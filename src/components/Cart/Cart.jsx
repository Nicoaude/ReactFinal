    ...
    return (
        <>
                ...
                <div className="espaciadoNav carritoVacio">
                    ...
                    <span>Agrega primero un producto para poder visualizar el carrito</span>
                ...
                <div className={`card cardCart border-light ${darkMode ? 'cartItemDarkColor' : ''} `} key={indice} style={{maxWidth: '700px'}}>
                    ...
                    <div className="card-body">
                        ...
                        <p className="card-text">Precio p/unidad: $ {new Intl.NumberFormat('de-DE').format(prod.precio)}</p>
